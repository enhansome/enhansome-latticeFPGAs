...
* [Glasgow revC](https://github.com/GlasgowEmbedded/glasgow) ⭐ 2,205 | 🐛 79 | 🌐 Python | 📅 2026-09-01
...
* [HX4k PMOD Breakout](https://github.com/rschlaikjer/hx4k-pmod) ⭐ 11 | 🐛 1 | 🌐 C++ | 📅 2020-09-08. 10 [PMODs](https://www.pcbway.com/project/shareproject/Lattice_HX4K_FPGA_Breakout.html)! [Reading more](https://rhye.org/post/fpgas-1-running-on-hardware/).
* [Manila-Ice](https://github.com/joshtyler/manila-ice) ⭐ 10 | 🐛 0 | 🌐 SystemVerilog | 📅 2021-03-02
...
* [DSP ICE](https://github.com/tvelliott/dsp_ice) ⭐ 62 | 🐛 1 | 🌐 C | 📅 2017-10-04. DSP ICE was developed because other boards didn't have all the features desired. The ultimate goal is to develop an SDR with swappable analog/RF front-ends.
...
* [logic-lp384](https://github.com/Agilack/pmod/tree/master/logic-lp384) ⭐ 10 | 🐛 0 | 🌐 C | 📅 2019-09-04. PMOD exposing a LP384 KiCad.
* [FPGA-384](https://www.siliconfrog.co.uk/cgibin/Pages/FPGA384.pl) by SiliconFrog. [SW code on github](https://github.com/siliconfrog/fpga-384) ⭐ 2 | 🐛 0 | 🌐 C++ | 📅 2018-09-27. / same for [esp32](https://github.com/siliconfrog/fpga-esp32) ⭐ 1 | 🐛 0 | 🌐 C | 📅 2020-02-07. [Shop](https://www.tindie.com/products/siliconfrog/fpga-384/).
...
* [CaribouLite](https://github.com/cariboulabs/cariboulite) ⭐ 1,330 | 🐛 116 | 🌐 C | 📅 2025-07-24 - open-source SDR platform ( CaribouLite utilizes the SMI (Secondary Memory Interface)  ).
...
* [iceRadio](https://github.com/emeb/iceRadio) ⭐ 82 | 🐛 0 | 🌐 C | 📅 2017-03-22 or [website](http://ebrombaugh.studionebula.com/radio/iceRadio/index.html). *This is a test prototype for experimenting with Software Defined Radio (SDR).*
...
* [lit3rick](https://github.com/kelu124/lit3rick/) ⭐ 42 | 🐛 0 | 🌐 Verilog | 📅 2024-07-16 - open source ultrasound pulse-echo raspberry pi hat shaped.

* [icehat](https://github.com/emeb/icehat) ⭐ 29 | 🐛 0 | 🌐 KiCad | 📅 2017-01-27. - with [custom flashing code](https://github.com/emeb/icehat/tree/master/ice_tool) ⭐ 29 | 🐛 0 | 🌐 KiCad | 📅 2017-01-27
...
* [ICE-dongle](https://github.com/emeb/ice-dongle) ⭐ 7 | 🐛 0 | 🌐 Verilog | 📅 2023-03-09 USB-C Dongle with ice40 UP5k FPGA

* [ice40helper](https://github.com/kehribar/ice40helper) ⭐ 6 | 🐛 0 | 🌐 C | 📅 2020-06-20

* [ice40-dev-board](https://github.com/medhyal/ice40-dev-board) ⭐ 5 | 🐛 0 | 📅 2021-04-19 by medhyal - simple breakout board

* [S1 Module](https://github.com/siliconwitchery/s1-module-kicad-library) ⭐ 3 | 🐛 0 | 📅 2022-01-28. Nordic nRF52811 with BlueTooth,  Maxim MAX77654 PMIC Battery Management, 32-Mbit of on board Flash,  6x12 mm. [Web site](https://docs.siliconwitchery.com/s1-module/s1-module/).

* [MTX-BC48-DB](https://github.com/mitexus/MTX-BC48-DB-Development-Board) ⭐ 1 | 🐛 0 | 📅 2021-03-16 UP5K + BLE
...
* [LUNA](https://github.com/greatscottgadgets/luna) ⭐ 1,135 | 🐛 32 | 🌐 Python | 📅 2026-08-19. A USB multitool for monitoring, hacking, and developing USB devices (work in progress). [crowdsupply](https://www.crowdsupply.com/great-scott-gadgets/luna).
* [Icepi Zero](https://github.com/cheyao/icepi-zero) ⭐ 822 | 🐛 4 | 🌐 HTML | 📅 2026-07-26 - ECP5 development board in a raspberry pi zero form . Includes an HDMI and uSD interface
...
* [ecp5-dev-board](https://github.com/medhyal/ecp5-dev-board) ⭐ 10 | 🐛 0 | 🌐 HTML | 📅 2021-04-19 by medhyal - simple breakout board
...
* [Colorlight I5\_V6](https://github.com/wuxx/Colorlight-FPGA-Projects) ⭐ 359 | 🐛 7 | 🌐 Verilog | 📅 2026-06-10 - with pins breakdowns by JohnnyW11773607. And a [testbed](https://twitter.com/JohnnyW11773607/status/1306807958165020672/photo/1)
